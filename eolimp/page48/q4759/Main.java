...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    print(doPerform(ls, new Executor() {
      @Override
    ...
    print(doPerform(ls, new Executor() {
      @Override
      public Long perform(long n, int i) {
        return String.valueOf(n).length()%2 == 1 ? n : null;
      }
    }));
  ...
  private static ArrayList<Long> doPerform(ArrayList<Integer>ls, Executor e) {
